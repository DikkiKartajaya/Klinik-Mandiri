...
if ($result->num_rows > 0) {
    ...
    echo "<form action='Logic/obat/updateStok.php?idObat=" . $row['idObat'] ."' method='post' enctype='multipart/form-data' id='formstok'>";
    ...
    echo "<div class='form-group'>";
    echo "<label class='form-label' for='Stok'>Jumlah Beli (strips/botol/pcs)</label>";
    echo "<input type='text' class='form-control' id='Stok' name='Stok' value='' required>";
    echo "</div>";
    
    echo "<div class='form-group'>";
    echo "<label class='form-label' for='hargaBeliObat'>Harga Beli</label>";
    echo "<input type='text' class='form-control' id='hargaBeliObat' name='hargaBeliObat' value='' required>";
    echo "</div>";
    ...
    echo "<div class='form-group'>";
    echo "<label class='form-label' for='notaPembelian'>Nota Pembelian</label>";
    echo "<input type='file' class='form-control' id='notaPembelian' name='notaPembelian' required>";
    echo "</div>";
